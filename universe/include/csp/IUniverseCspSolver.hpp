...
namespace Universe {
    ...
    public:
        ...
        virtual void addSupportSymbolic(
                const std::string &variable, const std::vector<std::string> &allowedValues) = 0;
        ...
        virtual void addSupportSymbolic(const std::vector<std::string> &variableTuple,
                const std::vector<std::vector<std::string>> &allowedValues) = 0;
        ...
        virtual void addConflicts(
                const std::string &variable, const std::vector<Universe::BigInteger> &forbiddenValues) = 0;
        ...
        virtual void addConflictsSymbolic(
                const std::string &variable, const std::vector<std::string> &forbiddenValues) = 0;
        ...
        virtual void addConflictsSymbolic(const std::vector<std::string> &variableTuple,
                const std::vector<std::vector<std::string>> &forbiddenValues) = 0;
