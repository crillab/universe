...
namespace Universe {
    ...
    public:
        ...
        void addAmong(const std::vector<std::string> &variables,
                const std::vector<BigInteger> &values, const Universe::BigInteger &count) override;
         ...
         * @throws UniverseContradictionException If adding the constraint results in a trivial inconsistency.
         */
        void addElement(const std::vector<std::string> &variables, const Universe::BigInteger &value) override;
         ...
         * @throws UniverseContradictionException If adding the constraint results in a trivial inconsistency.
         */
        void addElement(const std::vector<std::string> &variables, const std::string &value) override;
        ...
        void addElementConstantValues(const std::vector<Universe::BigInteger> &values,
                int startIndex, const std::string &index, const Universe::BigInteger &value) override;
         ...
         * @throws UniverseContradictionException If adding the constraint results in a trivial inconsistency.
         */
        void addElementConstantValues(
                const std::vector<Universe::BigInteger> &values, int startIndex,
                const std::string &index, const std::string &variable) override;
         ...
         * @throws UniverseContradictionException If adding the constraint results in a trivial inconsistency.
         */
        void addElement(const std::vector<std::string> &values,
                int startIndex, const std::string &index, const std::string &variable) override;
        ...
        void addPrimitive(const std::string &variable, Universe::UniverseArithmeticOperator arithOp,
                ...
                const BigInteger &rightHandSide) override;
        ...
        void addNValuesExcept(const std::vector<std::string> &variables,
                ...
                const std::vector<BigInteger> &except) override;
