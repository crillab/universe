...
namespace Universe {
    ...
    public:
        ...
        void addSupportSymbolic(
                const std::string &variable, const std::vector<std::string> &allowedValues) override;
        ...
        void addSupportSymbolic(const std::vector<std::string> &variableTuple,
                                        const std::vector<std::vector<std::string>> &allowedValues) override;
         ...
         */
        void addConflicts(
                const std::string &variable, const std::vector<Universe::BigInteger> &forbiddenValues) override;
        ...
        void addConflictsSymbolic(
                const std::string &variable, const std::vector<std::string> &forbiddenValues) override;
        ...
        void addConflictsSymbolic(const std::vector<std::string> &variableTuple,
                                          const std::vector<std::vector<std::string>> &forbiddenValues) override;
